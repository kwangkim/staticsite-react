...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"graphql-further-reading","title":"Further Reading","layout":"docs","category":"GraphQL","permalink":"docs/graphql-further-reading.html","indent":true,"next":"api-reference-relay","source":"GraphQL-FurtherReading.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
