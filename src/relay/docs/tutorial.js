...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"tutorial","title":"Tutorial","layout":"docs","category":"Quick Start","permalink":"docs/tutorial.html","next":"videos","source":"QuickStart-Tutorial.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
