...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"graphql-object-identification","title":"Object Identification","layout":"docs","category":"GraphQL","permalink":"docs/graphql-object-identification.html","indent":true,"next":"graphql-connections","source":"GraphQL-ObjectIdentification.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
