...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"guides-mutations","title":"Mutations","layout":"docs","category":"Guides","permalink":"docs/guides-mutations.html","next":"guides-network-layer","source":"Guides-Mutations.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
