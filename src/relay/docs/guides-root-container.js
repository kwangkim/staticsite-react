...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"guides-root-container","title":"Root Container","layout":"docs","category":"Guides","permalink":"docs/guides-root-container.html","next":"guides-ready-state","source":"Guides-RootContainer.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
