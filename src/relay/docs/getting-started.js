...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"getting-started","title":"Getting Started","layout":"docs","category":"Quick Start","permalink":"docs/getting-started.html","next":"tutorial","source":"QuickStart-GettingStarted.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
