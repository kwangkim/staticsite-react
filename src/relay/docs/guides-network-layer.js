...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"guides-network-layer","title":"Network Layer","layout":"docs","category":"Guides","permalink":"docs/guides-network-layer.html","next":"guides-babel-plugin","source":"Guides-NetworkLayer.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
