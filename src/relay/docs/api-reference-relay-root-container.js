...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"api-reference-relay-root-container","title":"Relay.RootContainer","layout":"docs","category":"API Reference","permalink":"docs/api-reference-relay-root-container.html","next":"api-reference-relay-ql","source":"APIReference-RootContainer.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
