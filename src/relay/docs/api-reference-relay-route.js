...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"api-reference-relay-route","title":"Relay.Route","layout":"docs","category":"API Reference","permalink":"docs/api-reference-relay-route.html","next":"api-reference-relay-root-container","source":"APIReference-Route.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
