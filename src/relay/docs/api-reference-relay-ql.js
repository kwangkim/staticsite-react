...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"api-reference-relay-ql","title":"Relay.QL","layout":"docs","category":"API Reference","permalink":"docs/api-reference-relay-ql.html","next":"api-reference-relay-mutation","source":"APIReference-QL.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
