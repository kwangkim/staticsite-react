...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"interfaces-relay-network-layer","title":"RelayNetworkLayer","layout":"docs","category":"Interfaces","permalink":"docs/interfaces-relay-network-layer.html","next":"interfaces-relay-mutation-request","source":"Interfaces-NetworkLayer.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
