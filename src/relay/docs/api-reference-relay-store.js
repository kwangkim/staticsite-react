...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"api-reference-relay-store","title":"Relay.Store","layout":"docs","category":"API Reference","permalink":"docs/api-reference-relay-store.html","next":"interfaces-relay-network-layer","source":"APIReference-Store.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
