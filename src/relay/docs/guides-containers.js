...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"guides-containers","title":"Containers","layout":"docs","category":"Guides","permalink":"docs/guides-containers.html","next":"guides-routes","source":"Guides-Containers.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
