...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"guides-babel-plugin","title":"Babel Relay Plugin","layout":"docs","category":"Guides","permalink":"docs/guides-babel-plugin.html","next":"graphql-relay-specification","source":"Guides-BabelPlugin.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
