...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"graphql-mutations","title":"Mutations","layout":"docs","category":"GraphQL","permalink":"docs/graphql-mutations.html","indent":true,"next":"graphql-further-reading","source":"GraphQL-Mutations.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
