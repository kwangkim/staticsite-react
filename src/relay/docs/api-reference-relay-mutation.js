...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"api-reference-relay-mutation","title":"Relay.Mutation","layout":"docs","category":"API Reference","permalink":"docs/api-reference-relay-mutation.html","next":"api-reference-relay-proptypes","source":"APIReference-Mutation.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
