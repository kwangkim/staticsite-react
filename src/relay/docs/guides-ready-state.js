...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"guides-ready-state","title":"Ready State","layout":"docs","category":"Guides","permalink":"docs/guides-ready-state.html","next":"guides-mutations","source":"Guides-ReadyState.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
