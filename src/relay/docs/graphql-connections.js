...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"graphql-connections","title":"Connection","layout":"docs","category":"GraphQL","permalink":"docs/graphql-connections.html","indent":true,"next":"graphql-mutations","source":"GraphQL-Connections.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
