...
var content = `\`RelayContainer\` is a higher-order React component that lets a React component encode its data requirements.
...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"api-reference-relay-container","title":"RelayContainer","layout":"docs","category":"API Reference","permalink":"docs/api-reference-relay-container.html","next":"api-reference-relay-route","source":"APIReference-Container.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
