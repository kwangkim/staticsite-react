...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"interfaces-relay-mutation-request","title":"RelayMutationRequest","layout":"docs","category":"Interfaces","permalink":"docs/interfaces-relay-mutation-request.html","indent":true,"next":"interfaces-relay-query-request","source":"Interfaces-MutationRequest.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
