...
var Post = React.createClass({
  ...
  render: function() {
    return <Layout metadata={{"id":"guides-routes","title":"Routes","layout":"docs","category":"Guides","permalink":"docs/guides-routes.html","next":"guides-root-container","source":"Guides-Routes.md"}}>{content}</Layout>;
  }
});
module.exports = Post;
